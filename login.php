...
if(isset($_POST['login'])) {
    ...
    if($num > 0) {
        ...
        echo "<script>alert('Login successful! Redirecting to your cart.');</script>";

        // Redirect to the referring page or default to my-cart.php
        $redirect_url = isset($_POST['redirect_url']) && !empty($_POST['redirect_url']) ? $_POST['redirect_url'] : "my-cart.php";
